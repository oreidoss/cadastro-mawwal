      ...
      <main className="flex-1 flex flex-col-reverse md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 animate-fade-in">
          <div className="max-w-md mx-auto bg-white/10 backdrop-blur-sm p-8 rounded-lg border border-white/20 shadow-xl">
            <h1 className="text-3xl md:text-4xl font-bold mb-3 text-amber-300">
              Cadastre seu <span className="gradient-text">interesse</span>
            </h1>
            <p className="text-amber-100 mb-8">
              Preencha o formulário abaixo para se registrar em nossa lista de
              interesses. Entraremos em contato com você em breve e você
              receberá nosso catálogo completo!
            </p>
